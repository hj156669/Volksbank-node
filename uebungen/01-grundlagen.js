...
console.log('In Excel würde das gleich so aussehen: =wenn(A1=lebensmittel;7;19)')
...
// Wert vor dem Doppelpunkt zurückgegeben. Ansonsten der Wert hinter dem Doppelpunkt.
...
// Die if-Kontrollstruktur kann 2 Fälle unterscheiden.
if(gesamtbetrag >= 100){
...
console.log('Wenn die Zahl kleiner oder gleich 5 ist, dann "negativ", wenn die Zahl > 5, dann "positiv" .');
